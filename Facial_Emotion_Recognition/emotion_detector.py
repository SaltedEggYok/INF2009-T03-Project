...
def write_image(image_path, image):
    ...
    :param image_path: path to write the image to
    :type image_path: str
...
def sync_time(results, start_time, output_file_name):
    '''
    Function to synchronize the time of the results
    :param results: dictionary of the results
    :type results: dict
    :param start_time: start time of the predictions
    :type start_time: str
...
def main():
    '''
    Main function to run the emotion detection model
    '''
    ...
    while True:
        try:
            ...
            for idx, face in enumerate(faces):
                ...
                text_location = (MARGIN + x, MARGIN + y)
